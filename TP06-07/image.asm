...
boucle: dec      ecx
  ...
  boucle3:	;itération sur les lignes
    ...
    sub     ecx,2	;on ne prend pas en compte la première et la dernière colone
  ...
  add ebx, edx	; on ajoute ensemble la valeur absolue de Gx et Gy
    ...
    g_positif:
		...
		mov edx, eax	;on place la valeur obtenue pour qu'elle se trouve dans la composante d'intensité du pixel
